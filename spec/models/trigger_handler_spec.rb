...
describe TriggerHandler do
  ...
  before do
    ["create", "update", "destroy"].map{ |crud| CrudAction.create(name: crud) }
  end
  ...
  describe ".perform" do
    ...
    it "Deal is updated and new deal stage is a 'dead' stage, update tasks and event to mark as 'cancelled'" do
      ...
      trigger = create :trigger, klass: "Deal", crud_action: update_crud  # trigger
      ...
      task_action.create_lookup_field_value_pair(field: "deal_id", value: "item.id", identifier: "lookup")
      task_action.change_field_value_pairs.create(field: "task_status_id", value: cancelled_status.id, identifier: "change")

      # action to perform
      event_action = create :action, trigger: trigger, klass: "Event"
      event_action.create_lookup_field_value_pair(field: "deal_id", value: "item.id", identifier: "lookup")
      event_action.change_field_value_pairs.create(field: "cancelled", value: true, identifier: "change")
    ...
    it "Lead Schedules showing for property and is assigned to an agent, create an event for that agent for the showing request" do
      ...
      # actions to perform
      event_action = create :action, trigger: trigger, klass: "Event", crud_action: create_crud
      event_action.change_field_value_pairs.create(field: "assignee_id", value: "item.agent.id", identifier: "change")
      # assuming the assignee is the creator when this trigger handling is automatic
      event_action.change_field_value_pairs.create(field: "creator_id", value: "item.agent.id", identifier: "change")
      event_action.change_field_value_pairs.create(field: "name", value: "Property Showing", identifier: "change")
    ...
    it "Lead contacts agent, create task to respond to that inquiry" do
      ...
      # actions to perform
      task_action = create :action, trigger: trigger, klass: "Task", crud_action: create_crud
      task_action.change_field_value_pairs.create(field: "assignee_id", value: "item.agent_id", identifier: "change")
      task_action.change_field_value_pairs.create(field: "creator_id", value: "item.agent_id", identifier: "change")
      task_action.change_field_value_pairs.create(field: "lead_id", value: "item.lead_id", identifier: "change")
      task_action.change_field_value_pairs.create(field: "name", value: "Follow up with inquiry", identifier: "change")
    ...
    it "Deal created for lead, add event for projected closing date" do
      ...
      # actions to perform
      event_action = create :action, trigger: trigger, klass: "Event", crud_action: create_crud
      event_action.change_field_value_pairs.create(field: "assignee_id", value: "item.agent_id", identifier: "change")
      event_action.change_field_value_pairs.create(field: "creator_id", value: "item.agent_id", identifier: "change")
      event_action.change_field_value_pairs.create(field: "lead_id", value: "item.lead_id", identifier: "change")
      event_action.change_field_value_pairs.create(field: "deal_id", value: "item.id", identifier: "change")
      event_action.change_field_value_pairs.create(field: "start_at", value: "item.proj_closing_date", identifier: "change")
      event_action.change_field_value_pairs.create(field: "name", value: "Projected deal closing", identifier: "change")
    ...
    it "Deal created for lead, add task to complete Purchase and Sale agreement by (due_date) ps_date" do
      trigger = create :trigger, klass: "Deal", crud_action: create_crud
      ...
      task_action.change_field_value_pairs.create(field: "creator_id", value: "item.agent_id", identifier: "change")
      task_action.change_field_value_pairs.create(field: "lead_id", value: "item.lead_id", identifier: "change")
      task_action.change_field_value_pairs.create(field: "due_date", value: "item.ps_date", identifier: "change")
      task_action.change_field_value_pairs.create(field: "name", value: "Complete Purchase and Sale agreement", identifier: "change")
    ...
    it "Lead signed up, create task to followup with lead" do
      ...
      # NOTE: This a requirements discovery point. Do we want to write functionality to randomly assign?
      ...
      task_action.change_field_value_pairs.create(field: "assignee_id", value: 1, identifier: "change")
      task_action.change_field_value_pairs.create(field: "creator_id", value: 1, identifier: "change")
      
      task_action.change_field_value_pairs.create(field: "lead_id", value: "item.id", identifier: "change")
      task_action.change_field_value_pairs.create(field: "name", value: "Followup with Lead", identifier: "change")
    ...
    it "Unassigned lead contacts agent, assign that lead to that agent" do
      ...
      # actions to perform
      lead_action = create :action, trigger: trigger, klass: "Lead", crud_action: update_crud
      lead_action.create_lookup_field_value_pair(field: "id", value: "item.lead_id", identifier: "lookup")
      lead_action.change_field_value_pairs.create(field: "agent_id", value: "item.agent_id", identifier: "change")
    ...
    it "Deal actual closing date changes, update event dates" do
      ...
      event = create :event, deal: deal, start_at: 1.week.ago, end_at: 1.week.ago

      trigger = create :trigger, klass: "Deal", crud_action: update_crud
      
      # actions to perform
      event_action = create :action, trigger: trigger, klass: "Event", crud_action: update_crud
      event_action.create_lookup_field_value_pair(field: "deal_id", value: "item.id", identifier: "lookup")
      event_action.change_field_value_pairs.create(field: "start_at", value: "item.actual_closing_date", identifier: "change")
      event_action.change_field_value_pairs.create(field: "end_at", value: "item.actual_closing_date", identifier: "change")
    ...
    it "Lead status changes to 'Dead' or 'Inactive', remove from marketing lists" do
      ...
      # actions to perform
      event_action = create :action, trigger: trigger, klass: "MarketingListLead", crud_action: destroy_crud
      event_action.create_lookup_field_value_pair(field: "lead_id", value: "item.id", identifier: "lookup")
    ...
    it "Lead's Agent changes, re-assign tasks and events to new agent" do
      ...
      event_action = create :action, trigger: trigger, klass: "Event", crud_action: update_crud
      event_action.create_lookup_field_value_pair(field: "lead_id", value: "item.id", identifier: "lookup")
      event_action.change_field_value_pairs.create(field: "assignee_id", value: new_agent.id, identifier: "change")

      task_action = create :action, trigger: trigger, klass: "Task", crud_action: update_crud
      task_action.create_lookup_field_value_pair(field: "lead_id", value: "item.id", identifier: "lookup")
      task_action.change_field_value_pairs.create(field: "assignee_id", value: new_agent.id, identifier: "change")
    ...
    it "Lead's Agent changes, remove lead from old agents marketing lists and add to new agent's marketing lists" do
      ...
      create(:marketing_list_lead, lead: create(:lead), marketing_list: marketing_list2)

      trigger = create :trigger, klass: "Lead", crud_action: update_crud

      marketing_list_action = create :action, trigger: trigger, klass: "MarketingList", crud_action: update_crud
      
      marketing_list_action.create_lookup_field_value_pair(field: "joins.marketing_list_leads.lead_id", value: "item.id", identifier: "lookup")
      marketing_list_action.change_field_value_pairs.create(field: "agent_id", value: new_agent.id, identifier: "change")
